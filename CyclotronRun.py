...
time2=0
deltat =1e-05  # time steps of 1ms
deltat_2=0.0002E-5
times = [0]
times_2=[]
Positions=[]
...
pd.DataFrame(Average_Positons).to_csv(r'C:\Users\benti\Documents\PHYS 389\1ProtonPositionsT1.csv')
pd.DataFrame(Average_Kinetic_Energies).to_csv(r'C:\Users\benti\Documents\PHYS 389\1ProtonKineticEnergyT1.csv')
pd.DataFrame(times).to_csv(r'C:\Users\benti\Documents\PHYS 389\1ProtonTimesT1.csv')
